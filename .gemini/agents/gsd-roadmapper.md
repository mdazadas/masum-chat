...
Reference full template: `F:/Websites/Masum Chats/.gemini/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `F:/Websites/Masum Chats/.gemini/get-shit-done/templates/state.md`.
