...
<reference>
@F:/Websites/Masum Chats/.gemini/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `F:/Websites/Masum Chats/.gemini/get-shit-done/references/user-profiling.md` to load:
